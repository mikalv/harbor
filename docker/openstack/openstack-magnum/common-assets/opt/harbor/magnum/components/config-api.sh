...
echo "${OS_DISTRO}:    Port: ${MAGNUM_API_SVC_PORT}"
echo "${OS_DISTRO}:    Listen: 127.0.0.1"
crudini --set ${MAGNUM_CONFIG_FILE} DEFAULT bind_port "${MAGNUM_API_SVC_PORT}"
crudini --set ${MAGNUM_CONFIG_FILE} magnum api_workers "${API_WORKERS}"
crudini --set ${MAGNUM_CONFIG_FILE} DEFAULT bind_host "127.0.0.1"
