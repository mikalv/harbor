...
CACHES = {
    'default': {
        ...
        'LOCATION': '{{ MEMCACHE_SERVICE_HOST_SVC }}:11211',
    }
}
...
DATABASES = {
    'default': {
        ...
        'NAME': '{{ AUTH_API_DB_NAME }}',
        'USER': '{{ AUTH_API_DB_USER }}',
        'PASSWORD': '{{ AUTH_API_DB_PASSWORD }}',
        'HOST': '{{ API_MARIADB_SERVICE_HOST_SVC }}',
        'default-character-set': 'utf8',
        'PORT': '{{ API_MARIADB_SERVICE_PORT }}',
        'OPTIONS':  {
                  'ssl': {'ca': '{{ API_DB_CA }}',
                          'cert': '{{ API_DB_CERT }}',
                          'key': '{{ API_DB_KEY }}',
