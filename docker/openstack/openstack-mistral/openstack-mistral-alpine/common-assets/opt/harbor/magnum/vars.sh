...
: ${AUTH_MISTRAL_KEYSTONE_TRUSTEE_PROJECT:="service"}
: ${AUTH_MISTRAL_KEYSTONE_TRUSTEE_PROJECT_DOMAIN:="mistral"}
: ${AUTH_MISTRAL_KEYSTONE_TRUSTEE_PROJECT_USER_ROLE:="admin"}
: ${AUTH_MISTRAL_KEYSTONE_TRUSTEE_DOMAIN:="mistral"}
: ${AUTH_MISTRAL_KEYSTONE_TRUSTEE_REGION:="RegionOne"}



: ${AUTH_MISTRAL_KEYSTONE_CLIENTS_REGION:="RegionOne"}
