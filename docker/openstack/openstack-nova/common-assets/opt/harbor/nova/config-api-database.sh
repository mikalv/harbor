...
"mysql://${AUTH_NOVA_API_DB_USER}:${AUTH_NOVA_API_DB_PASSWORD}@${NOVA_MARIADB_SERVICE_HOST_SVC}:${NOVA_MARIADB_SERVICE_PORT}/${AUTH_NOVA_API_DB_NAME}?charset=utf8&ssl_ca=${NOVA_DB_CA}&ssl_key=${NOVA_DB_KEY}&ssl_cert=${NOVA_DB_CERT}&ssl_verify_cert"
