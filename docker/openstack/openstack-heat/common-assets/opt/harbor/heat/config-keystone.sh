...
crudini --set ${HEAT_CONFIG_FILE} keystone_authtoken user_domain_name "${AUTH_HEAT_KEYSTONE_DOMAIN}"
crudini --set ${HEAT_CONFIG_FILE} keystone_authtoken region_name "${AUTH_HEAT_KEYSTONE_REGION}"
crudini --set ${HEAT_CONFIG_FILE} keystone_authtoken password "${AUTH_HEAT_KEYSTONE_PASSWORD}"
crudini --set ${HEAT_CONFIG_FILE} keystone_authtoken username "${AUTH_HEAT_KEYSTONE_USER}"
