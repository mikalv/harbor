...
: ${KEYSTONE_DB_CERT:="/run/harbor/auth/user/crt"}
...
: ${KEYSTONE_API_TLS_CA:="/run/harbor/auth/ssl/ca"}
: ${KEYSTONE_API_TLS_KEY:="/run/harbor/auth/ssl/key"}
: ${KEYSTONE_API_TLS_CERT:="/run/harbor/auth/ssl/crt"}

: ${KEYSTONE_MELLON_ACTIVE:="False"}

: ${KEYSTONE_MELLON_SP_METADATA:="/run/harbor/auth/mellon/sp-metadata"}
: ${KEYSTONE_MELLON_SP_TLS_KEY:="/run/harbor/auth/mellon/key"}
: ${KEYSTONE_MELLON_SP_TLS_CERT:="/run/harbor/auth/mellon/crt"}
